...
def sent2labels(sent):
    #print(sent)
    return [label for token, postag, label, sylinfo, patninfo in sent]

def sent2tokens(sent):
    #print(sent)
    return [token for token, postag, label, sylinfo, patninfo in sent]

train_sents=pickle.load(open('/Users/xinyi/UT/gavo/work/180521/train_sents_slash.txt','rb'))
recall_sum=0
precision_sum=0
f_measure_sum=0
for i in range(10):
